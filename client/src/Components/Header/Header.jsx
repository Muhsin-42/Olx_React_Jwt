    ...
    return (
        ...
        <div className="headerChildDiv">
          ...
          <div className="loginPage">
            <span>
                {/* {username} */}
              { username ? <span>{username}  <button onClick={logout}><Link className='Link' to="/login">Logout</Link></button></span> : <button><Link className='Link' to="/login">Login</Link></button>  }
            </span>
          </div>
